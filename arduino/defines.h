...
#include <config.h>  // Wifi Configuration Settings are Stored here

#define SINRIC_WEBSERVER          "iot.sinric.com"
#define SINRIC_WEBSERVER_PORT     80
#define SINRIC_API_KEY            "05d28170-aad5-4497-b5a3-b8f44616e7a0"

#define SINRIC_Device_ID_1        "5fefcc7dd3622611db381bee"   // Device ID, got from Sinric
